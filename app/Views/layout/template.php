...
<head>
    ...
    <style>
        ...
        .step-icon { width: 40px; height: 40px; background-color: #2ecc71; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; margin: 0 auto 10px; position: relative; z-index: 2; }
        .step-line { position: absolute; top: 20px; left: 0; right: 0; height: 3px; background-color: #2ecc71; z-index: 1; }
        .step-container { position: relative; }
        .card-alu { border: none; box-shadow: 0 2px 15px rgba(0,0,0,0.05); transition: 0.3s; }
        .card-alu:hover { transform: translateY(-5px); box-shadow: 0 5px 20px rgba(0,0,0,0.1); }
    </style>
</head>
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
                <a class="nav-link btn btn-primary text-white px-4 ms-2" href="<?= base_url('login') ?>">Masuk</a>
            </li>
          </ul>
        </div>
      </div>
