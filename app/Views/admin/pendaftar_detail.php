            ...
            <div class="card-body p-4">
                ...
                <?php if (!empty($biodata) && !empty($biodata['nim'])): ?>
                    ...
                    <table class="table table-sm table-borderless">
                        <tr>
                            ...
                            <td>: <?= esc($biodata['nim']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted">Perguruan Tinggi</td>
                            <td>: <?= esc($biodata['perguruan_tinggi']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted">Jurusan</td>
                            <td>: <?= esc($biodata['jurusan']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted">Semester</td>
                            <td>: <?= esc($biodata['semester']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted">No. HP / WA</td>
                            <td>: <?= esc($biodata['no_hp']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted">Alamat</td>
                            <td>: <?= esc($biodata['alamat']); ?></td>
                        </tr>
                    </table>
                    ...
                    <div class="list-group list-group-flush">
                        <a href="<?= base_url('uploads/cv/' . $biodata['file_cv']) ?>" target="_blank" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?= !$biodata['file_cv'] ? 'disabled' : '' ?>">
                            <span><i class="fas fa-file-pdf me-2 text-danger"></i> File CV</span>
                            <i class="fas fa-download text-primary"></i>
                        </a>
                        <a href="<?= base_url('uploads/surat/' . $biodata['file_surat_pengantar']) ?>" target="_blank" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?= !$biodata['file_surat_pengantar'] ? 'disabled' : '' ?>">
                ...
                <?php else: ?>
                    <p class="text-muted text-center fst-italic py-5">
                        ...
                        Peserta ini belum melengkapi biodata atau mengunggah dokumen.
                    </p>
                <?php endif; ?>
